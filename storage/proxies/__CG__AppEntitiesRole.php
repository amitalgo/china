...
class Role extends \App\Entities\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Role' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Role' . "\0" . 'role', '' . "\0" . 'App\\Entities\\Role' . "\0" . 'permission', '' . "\0" . 'App\\Entities\\Role' . "\0" . 'isActive', 'createdAt', 'updatedAt', '' . "\0" . 'App\\Entities\\Role' . "\0" . 'adminRole'];
        }
