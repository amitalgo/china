...
class ContactUsList extends \App\Entities\ContactUsList implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\ContactUsList' . "\0" . 'id', '' . "\0" . 'App\\Entities\\ContactUsList' . "\0" . 'subject', '' . "\0" . 'App\\Entities\\ContactUsList' . "\0" . 'contactNo', '' . "\0" . 'App\\Entities\\ContactUsList' . "\0" . 'message', '' . "\0" . 'App\\Entities\\ContactUsList' . "\0" . 'userId', '' . "\0" . 'App\\Entities\\ContactUsList' . "\0" . 'isActive', 'createdAt', 'updatedAt'];
        }
